...
class KioskFaceStore {
  ...
  Future<void> registrar({required int funcionarioId, required String imagePath, required String nome}) {
  ...
  Future<List<String>> identificar(String imagePath, {double threshold = 0.62}) {
    return FaceVerification.instance.identifyAllUsersFromImagePath(imagePath: imagePath, threshold: threshold);
  }
}
